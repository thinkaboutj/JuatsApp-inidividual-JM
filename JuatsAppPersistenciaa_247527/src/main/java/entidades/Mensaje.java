...
public class Mensaje {
    ...
    /**
     * Crea un nuevo mensaje sin contenido ni imagen, con la hora de envío
     * actual.
     */
    public Mensaje() {
    ...
    /**
     * Crea un nuevo mensaje con contenido de texto, sin imagen, y la hora de
     * envío actual.
     *
    ...
    /**
     * Crea un nuevo mensaje con una imagen adjunta, sin contenido de texto, y
     * la hora de envío actual.
     *
     * @param emisorId El identificador del emisor del mensaje.
